...
public class MockStorage extends AbstractStorage {
	...
	public void initUsers() {
		...
		this.users[0] = new User(1, "vasya", "new-york");
		this.users[1] = new User(2, "eva", "london");
		this.users[2] = new User(3, "alise", "san-francisco");
		this.users[3] = new User(4, "bob", "moscow");
	}
