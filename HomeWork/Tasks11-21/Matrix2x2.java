package ClassWork2.Alexeev_11302.ClassWork.CW17_11;
...
public class Matrix2x2 {
    ...
    public Matrix2x2 mult(Matrix2x2 m){
        ...
        result.matrix[1][0] = this.matrix[1][0] * m.matrix[0][0] + this.matrix[1][1] * m.matrix[1][0];
    ...
    public Vector2D multVector(Vector2D vector){
        Vector2D result = new Vector2D(matrix[0][0]*vector.getX() + matrix[0][1]*vector.getY(), matrix[1][0]*vector.getX() + matrix[1][1]*vector.getY());
        return result;
    }
}
